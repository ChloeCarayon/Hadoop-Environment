...
public class CountKindsMapperTest {
    @Mock
    private Mapper.Context context;
    private CountKindsMapper countKindsMapper;

    @Before
    public void setup() {
        this.countKindsMapper = new CountKindsMapper();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        ...
        this.countKindsMapper.map(null, new Text(value), this.context);
