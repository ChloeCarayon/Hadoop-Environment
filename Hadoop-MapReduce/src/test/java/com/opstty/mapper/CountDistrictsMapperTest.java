...
public class CountDistrictsMapperTest {
    @Mock
    private Mapper.Context context;
    private CountDistrictsMapper countDistrictsMapper;

    @Before
    public void setup() {
        this.countDistrictsMapper = new CountDistrictsMapper();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        ...
        this.countDistrictsMapper.map(null, new Text(value), this.context);
