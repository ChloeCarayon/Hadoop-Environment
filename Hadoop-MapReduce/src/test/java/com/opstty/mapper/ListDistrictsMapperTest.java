...
public class ListDistrictsMapperTest {
    @Mock
    private Mapper.Context context;
    private ListDistrictsMapper listDistrictsMapper;

    @Before
    public void setup() {
        this.listDistrictsMapper = new ListDistrictsMapper();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        ...
        this.listDistrictsMapper.map(null, new Text(value), this.context);
